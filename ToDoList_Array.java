...
public class ToDoList_Array{
	...
	public class TasksList{
		...
		public void largenTasksList(String[] tasksList){
			String[] newTasksList = new String[tasksList.length + 10];
			for(int i = 0; i < tasksList.length; i++){
				newTasksList[i] = tasksList[i];
			}
	...
	public static void main(String[] args) {
		...
		//PERSONAL MADE ARRAYLIST SYSTEM
		TasksList tasks = new ToDoList_Array().new TasksList();
